...
class TestSmokeTestSuite():
  ...
  def test_adminInvalidLogin(self):
    ...
    self.driver.find_element(By.ID, "password").send_keys("alskdfjasldkjf")
  ...
  def test_joinNameTest(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Samantha")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Atkins")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Silly Goose")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Silliest Goose")
